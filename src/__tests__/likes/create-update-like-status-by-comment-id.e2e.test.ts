import { createErrorMessages, dbHelper, delay, getBearerAuthorization, request } from '../test-helpers';
import { HTTP_STATUS_CODES, ROUTES } from '../../constants';
import { users, comments, fakeRequestedObjectId } from '../dataset';
import { CommentLikeStatusInputModel } from '../../features/likes/models';
...
describe('create/update like by comment ID', () => {
    ...
    it('returns 404 status code if there is no requested comment in database', async () => {
        const payload: CommentLikeStatusInputModel = {
            likeStatus: 'Like',
        };
